...
do
	...
	sed -i "47s/.*/          value: \"nrf$st\"/" oai-nrf/templates/deployment.yaml
	...
	sed -i "45s/.*/          value: \"udr$st\"/" oai-udr/templates/deployment.yaml
	...
	sed -i "47s/.*/          value: \"udm$st\"/" oai-udm/templates/deployment.yaml
	...
	sed -i "47s/.*/          value: \"ausf$st\"/" oai-ausf/templates/deployment.yaml
	...
	sed -i "55s/.*/          value: \"amf$st\"/" oai-amf/templates/deployment.yaml
	...
	sed -i "61s/.*/          value: \"smf$st\"/" oai-smf/templates/deployment.yaml
	sed -i "28s/.*/        type: edge/" oai-smf/templates/deployment.yaml
	...
	sed -i "27s/.*/        type: edge/" oai-spgwu-tiny/templates/deployment.yaml
	...
	do
		...
		sed -i "28s/.*/        image: xxxxxxxxxxx\/oai-dnn:${dnnim}/" oai-dnn/02_deployment.yaml
		sed -i "22s/.*/        type: edge/" oai-dnn/02_deployment.yaml
